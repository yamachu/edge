...
When use this library, replace `require('edge')` with `require('@yamachu/edge')`:

```diff
-var edge = require('edge');
+var edge = require('@yamachu/edge');
```
...
Edge.js runs on Windows, Linux, and OSX and requires Node.js 8.x, 7.x, 6.x, 5.x, 4.x, as well as .NET Framework 4.5 (Windows), Mono 4.2.4 (OSX, Linux), or .NET Core 1.0.4 (Windows, OSX, Linux). 
